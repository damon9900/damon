...
data,res = https.request("https://black-source.tk/Salvador/index.php?bn=info&id="..Id)
if res == 200 then
...
print("::SALVADOR::")
local RunBot = io.open("SALVADOR", 'w')
RunBot:write([[
#!/usr/bin/env bash
cd $HOME/SALVADOR
token="]]..database:get(Server_Done.."Token_Write")..[["
rm -fr SALVADOR.lua
wget "https://raw.githubusercontent.com/SALVADOR-TEAM/SALVADOR/master/SALVADOR.lua"
while(true) do
rm -fr ../.telegram-cli
./tg -s ./SALVADOR.lua -p PROFILE --bot=$token
done
]])
RunBot:close()
...
while(true) do
rm -fr ../.telegram-cli
screen -S SALVADOR -X kill
screen -S SALVADOR ./SALVADOR
done
]])
RunTs:close()
end
